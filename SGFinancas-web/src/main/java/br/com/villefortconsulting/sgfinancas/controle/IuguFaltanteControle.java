...
@NoArgsConstructor
@AllArgsConstructor
public class IuguFaltanteControle extends BasicControl implements Serializable {
    ...
    public StreamedContent gerarRelatorio() {
        try {
            gerarExcel(relatorioService.gerarRelatorioClientesComMovimentacaoSemIugu(data), "Relatório de movimentações de cliente com faturas IUGU faltantes");
