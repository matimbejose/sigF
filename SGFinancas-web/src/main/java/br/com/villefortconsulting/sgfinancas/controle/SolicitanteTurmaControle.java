...
@NoArgsConstructor
@AllArgsConstructor
public class SolicitanteTurmaControle extends BasicControl implements Serializable {
    ...
    public void postConstruct() {
        model = new VillefortDataModel<>(filtro, solicitanteService::quantidadeRegistrosSolicitanteTurmaFiltrados, solicitanteService::getListaSolicitanteTurmaFiltrada);
    }
