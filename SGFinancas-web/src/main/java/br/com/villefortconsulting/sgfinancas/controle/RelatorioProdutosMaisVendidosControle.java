...
@NoArgsConstructor
@AllArgsConstructor
public class RelatorioProdutosMaisVendidosControle extends BasicControl implements Serializable {
    ...
    public void gerarRelatorioProdutosMaisVenndidos() {
        try {
            gerarPdf(relatorioService.gerarRelatorioProdutosMaisVendidos(empresaService.getEmpresa(), dataInicio, dataFim), "ProdutosMaisVendidos.pdf");
            ...
            Logger.getLogger(RelatorioProdutosMaisVendidosControle.class.getName()).log(Level.SEVERE, null, ex);
