...
@NoArgsConstructor
@AllArgsConstructor
public class ServicoClienteControle extends BasicControl implements Serializable {
    ...
    public void gerarRelatorioServicoPorCliente() {
        try {
            gerarPdf(relatorioService.gerarRelatorioServicoCliente(clienteSelecionado, empresaService.getEmpresa(), dataInicio, dataFim), "servicoPorCliente.pdf");
    ...
    public List<Cliente> getClientes() {
        return vendaService.listaClienteServico(empresaService.getEmpresa());
    }
