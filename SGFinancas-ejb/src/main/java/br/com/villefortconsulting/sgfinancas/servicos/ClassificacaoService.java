...
public class ClassificacaoService extends BasicService<Classificacao, ClassificacaoRepositorio, ClassificacaoFiltro> {
    ...
    public void setEm(EntityManager em) {
        this.em = em;
        repositorio = new ClassificacaoRepositorio(em);
    }

    @Override
    public Criteria getModel(ClassificacaoFiltro filter) {
    ...
    public Classificacao buscarClassificacaoPorNumero(int numero) {
        return repositorio.getClassificaoByNumero(numero);
    }
