...
import br.com.villefortconsulting.sgfinancas.servicos.repositorios.VagaRepositorio;
...
public class VagaService extends BasicService<Vaga, VagaRepositorio, VagaFiltro> {
    ...
    protected void postConstruct() {
        repositorio = new VagaRepositorio(em, adHocTenant);
    }
    ...
    @Override
    public Criteria getModel(VagaFiltro filter) {
