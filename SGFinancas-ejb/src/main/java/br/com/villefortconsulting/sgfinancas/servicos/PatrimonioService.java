...
import br.com.villefortconsulting.sgfinancas.servicos.repositorios.PatrimonioRepositorio;
...
public class PatrimonioService extends BasicService<Patrimonio, PatrimonioRepositorio, PatrimonioFiltro> {
    ...
    protected void postConstruct() {
        repositorio = new PatrimonioRepositorio(em, adHocTenant);
    }
    ...
    @Override
    public Criteria getModel(PatrimonioFiltro filter) {
